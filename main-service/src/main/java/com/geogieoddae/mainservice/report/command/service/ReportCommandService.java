package com.geogieoddae.mainservice.report.command.service;

import com.geogieoddae.mainservice.client.UserFeignClient;
import com.geogieoddae.mainservice.client.UserInfoResponse;
import com.geogieoddae.mainservice.report.command.dto.ReportRequestDto;
import com.geogieoddae.mainservice.report.command.dto.ReportResponseDto;
import com.geogieoddae.mainservice.report.command.dto.ReportStatusUpdateDto;
import com.geogieoddae.mainservice.report.command.dto.ReportTypeRequestDto;
import com.geogieoddae.mainservice.report.command.dto.ReportTypeResponseDto;
import com.geogieoddae.mainservice.report.command.dto.RestaurantBlacklistRequestDto;
...
import com.geogieoddae.mainservice.report.command.repository.ReportRepository;
import com.geogieoddae.mainservice.report.command.repository.ReportTypeRepository;
import com.geogieoddae.mainservice.report.command.repository.RestaurantBlacklistRepository;
...
public class ReportCommandService {
    ...
    public ReportResponseDto createReport(ReportRequestDto reportRequestDto, Long userCode) {
        ...
        // UserEntity 조회
        UserInfoResponse user = userFeignClient.getUserById(userCode);
