package com.geogieoddae.mainservice.pay.command.service;


import com.geogieoddae.mainservice.client.EntrepreneurFeignClient;
import com.geogieoddae.mainservice.pay.command.dto.EntrepreneurSubscribePaymentRequest;
import com.geogieoddae.mainservice.pay.command.entity.EntrepreneurSubscribePaymentEntity;
import com.geogieoddae.mainservice.pay.command.repository.EntrepreneurSubscribePaymentRepository;
...
public class EntrepreneurSubscribePaymentService {
    ...
    public Map<String, Object> subscribePaymentCharge(
        ...
        String orderId = entrepreneurSubscribePayment.getEntrepreneurCode() + "_" + UUID.randomUUID();//결제 생성시 마다 주문아이디 생성
    ...
    public void subscribePaymentSave(
        ...
        EntrepreneurSubscribePaymentEntity subscribePaymentEntity = EntrepreneurSubscribePaymentEntity.builder()
                ...
                .entrepreneurCode(entrepreneurFeignClient.getEntrepreneurById(request.getEntrepreneurId()))
                .build();
